  ...
  return (
    <aside className="flex flex-col max-w-aside w-full bg-grey-50 dark:bg-grey-900 h-screen border-r-2 border-grey-300 dark:border-grey-700">
      <header className="px-4 py-3 w-full">
        <div className="flex">
          {openSearch ? (
            <span className="w-11 h-11 flex items-center justify-center rounded-full hover:bg-grey-200 dark:hover:bg-grey-800 cursor-pointer text-grey-950 dark:text-grey-50">
              <ArrowLeftIcon />
            </span>
          ) : (
            <DropDownMenu />
