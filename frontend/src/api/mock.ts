...
export const channels = [
...

  {
    ...
    name: 'Daryl Bogisich',
    latest_message: 'You:Store is out of stock',
    time: 'Yesterday',
  },

  {
    avatar_path:
      'https://plus.unsplash.com/premium_photo-1669882305300-38b609862bee?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8YXZhdGFyfGVufDB8fDB8fHww',
    name: 'SpaceX Crew-16 Launch',
    latest_message: "I've been there!",
    time: 'Thursday',
  },

  {
    ...
    name: 'Lela Walsh',
    latest_message: "Next time it's my turn",
    time: '12/22/21',
  },
  {
    avatar_path:
    ...
    name: 'Roland Marks',
    latest_message: '@waldo Glad to hear that 🐱',
    time: '12/16/21',
  },
  {
    avatar_path:
